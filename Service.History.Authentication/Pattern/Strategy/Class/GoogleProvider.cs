...
{
    internal class GoogleProvider : IAuthProvider
    {
        #region Properties
        ...
        public GoogleProvider(IServiceProvider provider)
        {
        ...
        public ChallengeResult ChallengeResult()
        {
            using (IServiceScope scope = this._provider.CreateScope())
            {
                ...
                var properties = signInManager.ConfigureExternalAuthenticationProperties(GoogleDefaults.AuthenticationScheme, this.GoogleResponseUrl());
        ...
        private string GoogleResponseUrl()
        {
            using (IServiceScope scope = this._provider.CreateScope())
            {
                ...
                return url.Action("GoogleResponse", "Account")!;
            }
        }
